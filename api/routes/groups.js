...
router.get('/', (req, res, next) => {
  ...
  Group.find()
    ...
    .populate('active_image', '_id')
    // populate images
    .populate('images', '_id')
    // populate displays
    .populate('displays', '_id')
    // populate user
    .populate('user', '_id')
    .exec()
    // return docs as JSON
...
router.get('/:id', (req, res, next) => {
  ...
  Group.findById(_id)
    // populate active image
    .populate('active_image', '_id id url src_url name descrption created_at tags_total')
    // populate images
    .populate('images', '_id id url src_url name descrption created_at tags_total')
    // populate displays
...
router.post('/', (req, res, next) => {
  ...
  const { id, name, description, user, displays, images, active_image, tags } = req.body;

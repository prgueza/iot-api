...
exports.update = ( req, res, next ) => {
  if ( last_update && moment()
    ...
    Gateway.find()
      .select( 'sync_url' )
      .exec()
      .then( ( gateways ) => { // get all sync_urls for the gateways stored in the database
        var urls = gateways.map( ( g ) => g.sync_url ) // map the urls into an array
  ...
  Promise.all( [
    ...
    .then( doc => {
      ...
      fs.readFile( file_path, ( err, data ) => {
        ...
        axios.put( gateway.sync_url, form, {

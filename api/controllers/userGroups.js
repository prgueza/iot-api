...
/* GET ALL */
exports.userGroups_get_all = (req, res) => {
...
/* GET ONE */
exports.userGroups_get_one = (req, res) => {
  if (!req.AuthData.admin) {
    res.status(401)
      .json({ message: 'Not allowed' });
  } else {
...
/* POST */
exports.userGroup_create = (req, res) => {
  if (!req.AuthData.admin) {
    res.status(401)
      .json({ message: 'Not allowed' });
  } else {
...
/* PUT */
exports.userGroup_update = (req, res) => {
  if (!req.AuthData.admin) {
    res.status(401)
      .json({ message: 'Not allowed' });
  } else {
...
/* DELETE */
exports.userGroup_delete = (req, res) => {
  if (!req.AuthData.admin) {
    res.status(401)
      .json({ message: 'Not allowed' });
  } else {
